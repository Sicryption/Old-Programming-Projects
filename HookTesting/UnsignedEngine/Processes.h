...
public:
	...
	{
		return FindWindowA(NULL, "HookTestProject");
	}
	...
	static string ReadString(DWORD Offset, bool direct = false)
	{
		...
		DWORD ProcessID = FindProcessId(L"HookTestProject.exe");
	...
	static bool tryToFindProcess()
	{
		if (LeagueWindow == NULL)
		{
			cout << "Process is closed!\n";
			return false;
		}
		cout << "Process is open!\n";
		return true;
	}
};
